...
public class MemberMethodReturnMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("main block-->add(1,2)반환데이타 :" + memberMethodReturn.add(1, 2));
		String name = "김수한";
		...
		System.out.println("*************getter 메쏘드호출*************");
		...
		System.out.println("*************setter 메쏘드호출*************");
		// memberMethodReturn.setMemberField1(100);
		memberMethodReturn.memberField1 = 100;
