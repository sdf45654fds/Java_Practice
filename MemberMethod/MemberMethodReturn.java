...
public class MemberMethodReturn {
	...
	public int method1() {
		...
		System.out.println("\t---int method1()실행종료후 int데이타 반환");
		/*
	...
	public boolean method2() {
		...
		System.out.println("\t---boolean method2()실행종료후 boolean데이타 반환");
		return isMarried;
	}
	...
	public int add(int a, int b) {
		...
		System.out.println("\t---int add(int a,int b)실행종료후 int 데이타반환");
		return a + b;
	}
