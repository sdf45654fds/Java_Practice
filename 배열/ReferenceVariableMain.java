...
public class ReferenceVariableMain {
	public static void main(String[] args) {
		...
		Account account1 = new Account(1325, "LEE", 56000, 3.5);
		Account account2 = account1;
		Account account3 = new Account(9090, "KIM", 89000, 5.9);
		...
		if (account1 != account2) {
			System.out.println("주소값이 다르다-->" + account1 + "!=" + account2);
		}
		 ...
		 * 
		 *  - 객체주소의 초기화의 용도로 사용
		 *  - null주소를 사용해서 멤버에 접근 시도시에는 NullPointerException 예외가 발생하고
		 *    프로그램이 종료된다.
		 */
